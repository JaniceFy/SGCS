                                            ...
                                            <div class="toggle-wrap nk-block-tools-toggle">
                                                ...
                                                <div class="toggle-expand-content" data-content="pageMenu">
                                                    <ul class="nk-block-tools g-3">
                                                        <li>
                                                            <div class="dropdown">
                                                                <a href="#" class="dropdown-toggle btn btn-white btn-dim btn-outline-light" data-bs-toggle="dropdown"><em class="d-none d-sm-inline icon ni ni-calender-date"></em><span><span class="d-none d-md-inline">Últimos</span> 30 días</span><em class="dd-indc icon ni ni-chevron-right"></em></a>
                                                                <div class="dropdown-menu dropdown-menu-end">
                                                                    <ul class="link-list-opt no-bdr">
                                                                        <li><a href="#"><span>Últimos 30 días</span></a></li>
                                                                        <li><a href="#"><span>Últimos 6 meses</span></a></li>
                                                                        <li><a href="#"><span>Último 1 año</span></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="nk-block-tools-opt"><a href="#" class="btn btn-primary"><em class="icon ni ni-reports"></em><span>Reportes</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head-content -->
                                            ...
                                            <div class="card card-bordered h-100">
                                                <div class="card-inner">
                                                    <div class="card-title-group pb-3 g-2">
                                                        <div class="card-title card-title-sm">
                                                            <h6 class="title">Estadísticas de Informe de Importación y Gastos</h6>
                                            ...
                                            <div class="card card-bordered h-100">
                                                <div class="card-inner mb-n2">
                                                    <div class="card-title-group">
                                                        ...
                                                        <div class="card-tools">
                                                            <div class="drodown">
                                                                <a href="#" class="dropdown-toggle dropdown-indicator btn btn-sm btn-outline-light btn-white" data-bs-toggle="dropdown">30 Días</a>
                                                ...
                                                <div class="nk-tb-list is-loose traffic-channel-table">
                                                    <div class="nk-tb-item nk-tb-head">
                                                        ...
                                                        <div class="nk-tb-col nk-tb-prev-sessions"><span>Conteo Anterior</span></div>
                                                        <div class="nk-tb-col nk-tb-change"><span>Cambio</span></div>
                                                        <div class="nk-tb-col nk-tb-trend tb-col-sm text-end"><span>Estadísticas</span></div>
                                                    </div><!-- .nk-tb-head -->
                                                ...
                                                <div class="card-inner-group">
                                                    <div class="card-inner">
                                                        <div class="card-title-group">
                                                            ...
                                                            <div class="card-tools">
                                                                <a href="html/crm/recent-sale.html" class="link">Ver Todo</a>
                                                            </div>
                                                        ...
                                                        <table class="nk-tb-list nk-tb-ulist">
                                                            <thead>
                                                                <tr class="nk-tb-item nk-tb-head">
                                                                    ...
                                                                    <th class="nk-tb-col"><span class="sub-text">Precio</span></th>
                                                                    ...
                                                                    <th class="nk-tb-col nk-tb-col-tools text-end">
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                                <ul class="link-list-opt no-bdr">
                                                                                    <li><a href="#"><em class="icon ni ni-check-round-cut"></em><span>Marcar como Hecho</span></a></li>
                                                                                    <li><a href="#"><em class="icon ni ni-archive"></em><span>Marcar como Archivado</span></a></li>
                                                                                    <li><a href="#"><em class="icon ni ni-trash"></em><span>Eliminar Tareas</span></a></li>
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                                    </th>
